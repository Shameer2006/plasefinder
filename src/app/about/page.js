    ...
    <>
      ...
      <section style={{ padding: '3rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginTop: '2rem', marginBottom: '1rem', color: '#9ca3af' }}>
          Explore Our Masterclass Strategy Guides
        </h3>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
          {[
            ['/guides/25-pro-street-view-geoguessr-secrets', '25 Pro Secrets'],
            ['/guides/street-view-camera-generations-guide', 'Camera Gens Guide'],
            ['/guides/latin-america-street-view-guide', 'Latin America Guide'],
            ['/guides/europe-street-view-guide', 'Europe Street View'],
            ['/guides/asia-street-view-guide', 'Asia Street View'],
            ['/guides/africa-street-view-guide', 'Africa Street View'],
            ['/guides/flag-identification-guide', 'Flag Identification'],
            ['/guides', 'All Guides Catalog →']
          ].map(([url, title]) => (
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: '1.25rem', justifyContent: 'center', flexWrap: 'wrap', fontSize: '0.85rem' }}>
          ...
          <Link href="/guides" style={{ color: '#9ca3af', textDecoration: 'none' }}>Guides &amp; Strategy</Link>
          ...
          <Link href="/about" style={{ color: '#10b981', textDecoration: 'none', fontWeight: 600 }}>About Us</Link>
