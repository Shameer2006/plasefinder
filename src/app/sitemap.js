...
export default function sitemap() {
  const baseRoutes = [
    { url: 'https://www.loststreet.online', lastModified: new Date('2026-07-26'), changeFrequency: 'daily', priority: 1.0 },
    { url: 'https://www.loststreet.online/about', lastModified: new Date('2026-07-26'), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://www.loststreet.online/leaderboard', lastModified: new Date('2026-07-26'), changeFrequency: 'daily', priority: 0.8 },
    { url: 'https://www.loststreet.online/guides', lastModified: new Date('2026-07-26'), changeFrequency: 'weekly', priority: 0.9 },
    { url: 'https://www.loststreet.online/chronicles', lastModified: new Date('2026-07-26'), changeFrequency: 'weekly', priority: 0.9 },
